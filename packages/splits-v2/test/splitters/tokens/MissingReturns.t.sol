...
import { MissingReturnToken } from "../../mocks/MissingReturns.sol";
import { Address } from "@openzeppelin/contracts/utils/Address.sol";

contract MissingReturnsTest is BaseTest {
    ...
    MissingReturnToken private customToken;
    ...
    function setUp() public override {
        ...
        customToken = new MissingReturnToken(0);
